...
--
-- Host: 127.0.0.1
-- Tempo de geração: 05-Dez-2022 às 04:11
...
(14, 'Lucas', 'Comb Over', '02/12/2022', '10:30', '20,00'),
(15, 'Victor', 'Comb Over', '12/12/2022', '12:00', '20,00'),
(16, 'Danilo', 'Bowl Cut', '04/12/2022', '10:30', '20,00'),
(23, 'Danilo', 'Bowl Cut', '11/12/2022', '09:00', '25,00'),
(24, 'Henrique', 'Crew Cut', '07/12/2022', '09:00', '35,00'),
(25, 'Henrique', 'Bowl Cut', '05/12/2022', '09:00', '25,00');
...
--
ALTER TABLE `tblagendamento`
  MODIFY `cod_cliente` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT de tabela `tblcliente`
--
ALTER TABLE `tblcliente`
  MODIFY `cod_cliente` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
